...
import {FlatList as DefaultFlatList, Text as DefaultText, useColorScheme, View as DefaultView } from 'react-native';
...
// export type PickerProps = ThemeProps & DefaultPicker<any>['props'];
...
//   return <DefaultPicker style={[{ backgroundColor }, style]} {...otherProps} />;
// }
